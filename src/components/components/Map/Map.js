...
export const Map = ({
  ...
  const defaultTargetName = useLocationNameByCoordinate({
    ...currentTarget,
    open: !isRoute,
  });
...
//   };
  ...
  return (
    <MapContainer
      center={[defaultTarget.latitude, defaultTarget.longtitude]}
      zoom={13}
    ...
    >
      ...
      <div className={`distanceModal ${distance ? 'distanceModalActive' : ''}`}>
        {distance} km
      </div>
    </MapContainer>
  );
