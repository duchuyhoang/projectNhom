      ...
      <Container>
        ...
        <ContainerCardList isMobile={isMobile}>
          {cardList.map((item, index) => {
            return (
              <CardWrapper isMobile={isMobile} key={index}>
                <CNCard
                  className={serviceComponentStyles.cardContainer}
                  headerComponent={
                    <SVGContainer
                      className={serviceComponentStyles.SVGContainer}
                    >
                      <SVGIcon
                        className={serviceComponentStyles.SVGStyles}
                        name={item.SVGIcon}
                        width="80px"
                        height="80px"
                      />
                  ...
                  bodyComponent={
                    <>
                      <CardTitle className={serviceComponentStyles.CardTitle}>
                        {item.title}
                      </CardTitle>
                      <CardInfo className={serviceComponentStyles.CardInfo}>
                        {item.description}
                      </CardInfo>
                    </>
                  }
